...
<!-- <link href="${requestScope.myBasePath}hqbpmn/jslib/jquery-plugin/tbar/css/jquery-wk.toolbar.css" rel="stylesheet" type="text/css" media="screen"/> 
<link href="${requestScope.myBasePath}hqbpmn/jslib/jqueryUILayout/css/jquery-ui-1.9.2.custom.min.css" rel="stylesheet" type="text/css" media="screen"/>-->
...
<%-- <link rel="stylesheet" type="text/css" media="screen" href="${requestScope.myBasePath}hqbpmn/jslib/jqgrid/themes/ui.jqgrid.css" /> --%>
...
<script src="${myBasePath}hqbpmn/bpmnlog/scanBpmnLog.js" type="text/javascript"></script>
<script type="text/javascript">
    ...
    var currentYear = '<%=request.getParameter("currentYear")%>';
    ...
    var isShowUnfinshedNodes = '<%=request.getParameter("isShowUnfinshedNodes")%>';
