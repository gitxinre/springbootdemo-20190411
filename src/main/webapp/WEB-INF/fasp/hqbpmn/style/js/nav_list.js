...
}) (jQuery); function ResumeError() {
return true;
}
window.onerror = ResumeError; if ($.browser.isIE6) {
try {
    document.execCommand('BackgroundImageCache', false, true);
} catch (err) {
}
}; var calluri = 'http://fairyservice.360buy.com/WebService.asmx/MarkEx?callback=?'; var loguri = 'http://csc.360buy.com/log.ashx?type1=$type1$&type2=$type2$&data=$data$&callback=?'; callback1 = function (data) {
;
...
}; var gi_normal__ = new Object(); gi_normal__.deliver = function (arg) {
...
}; gi_focus__ = new Object(); gi_focus__.next = function () {
...
gi_focus__.next();
}; var gi_rotate__ = new Object(); gi_rotate__.deliver = function (arg) {
var ad_arr = arg.gi_ad_arr;
